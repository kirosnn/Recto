      ...
      {isSharing && (
        ...
        >
          <span style={{
            ...
            background: "#4caf7d", boxShadow: "0 0 8px rgba(76,175,125,0.7)",
          }} />
          <span style={{ flex: 1, textAlign: "left", fontSize: "0.85rem", color: "var(--tx)", fontWeight: 500 }}>
            Partage en cours{status === "connected" ? " · Connecté" : " · En attente"}
          </span>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.82rem", color: "var(--tx-2)", letterSpacing: "0.06em" }}>
            {code}
          </span>
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{ color: "var(--tx-3)", flexShrink: 0 }}>
